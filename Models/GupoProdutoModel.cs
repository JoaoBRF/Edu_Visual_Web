    ...
    {   
        ...
        public static bool ExcluirPeloId(int id)
        {
            ...
            if (RecuperarPeloId(id) != null)
            {
                using (var conexao = new SqlConnection())
                {
                    conexao.ConnectionString = @"Data Source=JOTTA\MSSQLSERVER01;Initial Catalog=controle-estoque;User Id=admin;Password=123";
                    conexao.Open();
                    using (var comando = new SqlCommand())
                    {
                        comando.Connection = conexao;
            ...
            using (var conexao = new SqlConnection())
            {
                ...
                using (var comando = new SqlCommand())
                {
                    ...
                    if (model == null)
                    {
                        ...
                        comando.CommandText = "insert into grupo_produto (nome, ativo) values(@nome, @ativo); select convert(int, scope_indentity())";
